...
video_capture = cv2.VideoCapture('/home/mohit/Downloads/project_mlops/MLOps-Project/Data Pipeline/Data/video2.webm')
...
while True:
    ...
    # Adjust delay for smooth playback (25ms = ~40 FPS)
