...
class InterviewAnalyzer:
    ...
    def load_llm_model(self, model_name="google/flan-t5-base"):
        ...
        try:
            ...
            if "t5" in model_name.lower() or "flan" in model_name.lower() or "fine_tuned" in model_name.lower():
    ...
    def analyze_answer(self, question, answer, context="job interview"):
        ...
        try:
            ...
            # Updated prompt to match fine-tuning format
            prompt = f"""Evaluate this interview answer and provide detailed feedback with numerical scores (1-10).
...
1. Detailed feedback explaining strengths and weaknesses
2. Numerical scores in format: Structure: [score]/10 | Clarity: [score]/10 | Relevance: [score]/10 | Overall: [score]/10
"""
...
if __name__ == "__main__":
    ...
    # OLD OPTIONS (commented out - these are the generic untrained models):
    # analyzer.load_llm_model("microsoft/Phi-3-mini-4k-instruct")  # Generic model
    # analyzer.load_llm_model("google/flan-t5-large")              # Generic model  
    # analyzer.load_llm_model("google/flan-t5-base")               # Generic model
