        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-bold text-white">Pitching</h1>
            </div>
          </div>
        </div>
      </header>
        ...
        {!results ? (
          <>
            <div className="mb-8 p-6 bg-gradient-to-br from-gray-900 to-black border border-green-500/20 rounded-2xl max-w-4xl mx-auto">
              ...
              <p className="text-gray-400 leading-relaxed">
                Upload a video of your pitch. Our AI will analyze your delivery, 
                storytelling, vocal tone, and provide actionable feedback to help you refine your pitch.
              </p>
            </div>
                ...
                <div className="pointer-events-none">
                  ...
                  {file ? (
                    ...
                    <>
                      ...
                      <p className="text-sm text-gray-400">Supports MP4, MOV, AVI (Max 500MB)</p>
                    </>
                  )}
                </div>
              </div>
          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-r from-emerald-600 to-green-600 rounded-2xl p-8 text-center">
              ...
              <div className="text-6xl font-bold text-white mb-2">{results.overall_score}/100</div>
              <p className="text-white/90 text-lg capitalize">{results.performance_level} Level</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              {Object.entries(results.category_scores).map(([category, data]) => (
                <div key={category} className="bg-gradient-to-br from-gray-900 to-black border border-green-500/20 rounded-xl p-6">
                  <h3 className="text-sm font-medium text-gray-400 mb-2 capitalize">{category.replace('_', ' ')}</h3>
                  <div className={`text-3xl font-bold mb-2 ${getScoreColor(data.score)}`}>{data.score}</div>
            ...
            <div className="bg-gradient-to-br from-gray-900 to-black border border-green-500/20 rounded-xl p-6">
              <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-2"><TrendingUp className="w-6 h-6 text-green-500" />Strengths</h3>
            ...
            <div className="bg-gradient-to-br from-gray-900 to-black border border-green-500/20 rounded-xl p-6">
              <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-2"><Target className="w-6 h-6 text-yellow-500" />Areas for Improvement</h3>
              <div className="space-y-3">
                {results.improvements.map((improvement, idx) => (
                  <div key={idx} className="p-4 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <span className="text-xs px-2 py-1 bg-yellow-500/20 text-yellow-400 rounded">{improvement.priority}</span>
                    </div>
            ...
            <div className="flex gap-4">
              <button onClick={handleReset} className="flex-1 bg-gradient-to-r from-emerald-600 to-green-600 text-white font-semibold py-3 px-6 rounded-lg hover:from-emerald-700 hover:to-green-700 transition-all duration-300">Analyze Another Video</button>
            </div>
          </div>
        )}
      </main>
