...
def extract_frames(video_path: str, sample_rate: int = None, **context) -> Dict:
    """
    ...
    if dag_run and hasattr(dag_run, 'conf') and dag_run.conf:
        video_id = dag_run.conf.get('video_id', 'unknown')
    else:
        video_id = 'test_video'
...
def extract_audio(video_path: str, **context) -> Dict:
...
def cleanup_temp_files(frames_dir: str = None, audio_path: str = None, **context) -> None:
    """
